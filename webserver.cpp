...
/*
Reference url:
https://docs.microsoft.com/en-us/windows/win32/http/http-server-sample-application?redirectedfrom=MSDN
*/
...
int main()
{
    ...
    const wstring url = L"http://localhost:8080/test"; //can change this url as your wish
    ...
    retCode = HttpAddUrl(hReqQueue, url.c_str(), NULL);
    if (retCode != NO_ERROR) //5 is access_denied
    {
...
CleanUp:
    ...
    {
        HttpRemoveUrl(hReqQueue,url.c_str());
    }
    ...
    for (;;)
    {
        ...
        if (NO_ERROR == result)
        {
            ...
            default:
                ...
                result = SendHttpResponse(hReqQueue,pRequest,503,(PSTR)"Not Implemented",NULL);
                break;
            }
